...
const Footer = async ({ blok }: { blok?: FooterItem[] }) => {
	...
	return (
		<footer className="bg-[#151958] text-white">
			{/* Main Footer Section */}
				...
				<div className="max-w-6xl mx-auto text-center">
					...
					<div className="mb-8">
						<div className="flex items-center justify-center mb-4">
							{/* DigitalHub Logo - Recycling Symbol */}
							...
							<h2 className="text-2xl font-bold">DigitalHub</h2>
						</div>
					</div>

					{/* Address */}
					<div className="mb-6">
						<p className="text-sm mb-1">Hardstrasse 201</p>
			...
			{/* Bottom Bar */}
			<div className="bg-[#0c0f2d] px-6 py-4">
